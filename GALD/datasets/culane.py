...
# }
CATEGORYS = {
    'daytime': 'list/test_split/daytime_test.txt',
    'night': 'list/test_split/night_test.txt',
    'rainy': 'list/test_split/rainy_test.txt',
    'tunnel': 'list/test_split/tunnel_test.txt',
    'strong': 'list/test_split/strong_light.txt',
    'weak': 'list/test_split/weak_light.txt',
}
